...
const DropDown = forwardRef((props, ref) => {
    ...
    const { visible, onDismiss, showDropDown, value, setValue, activeColor, mode, label, placeholder, inputProps, list, dropDownContainerMaxHeight, theme, containerStyle,underlineColor, inputStyle } = props;
    ...
    return (<Menu visible={visible} onDismiss={onDismiss} theme={theme} anchor={<TouchableRipple ref={ref} onPress={showDropDown} onLayout={onLayout}>
            <View pointerEvents={"none"} style={containerStyle}>
              <TextInput value={displayValue} underlineColor={underlineColor} mode={mode} label={label} placeholder={placeholder} pointerEvents={"none"} theme={theme} {...inputProps} style={[{
